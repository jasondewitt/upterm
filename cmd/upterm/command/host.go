...
func hostCmd() *cobra.Command {
  ...
  upterm host --server wss://YOUR_UPTERMD_SERVER -- YOUR_COMMAND`,
	...
	cmd.PersistentFlags().BoolVarP(&flagSkipSessionConfirm, "skip-session-confirm", "", false, "Skip confirmation on session creation.")
